...
<head>
    ...
    <meta name="description" content="Hi there! we are the new kids on the block and we bulid awesome websites and mobile apps. A single page PSD to HTML">
...
<body>
    <header id="home">
        <nav>
            <div class="row">
                <a href="#home">
                    <img src="img/logo.png" alt="cuda" class="logo">
                </a>
                <ul class="main-nav">
        ...
        <div class="row">
            <div class="hero-text-box">
                <h1>Hi there! we are the new kids on the block and we bulid awesome websites and mobile apps.</h1>
                <a href="#contact" class="btn btn-hero">work with us!</a>
            </div>
        </div>
    </header>

   <section class="service-section js--services-section" id="service">
       <div class="row">
           <h2>SERVICES WE PROVIDE</h2>
           <p class="little-description">We are working with both individuals and bussiness from all over the glove to create awesome websites and applications.</p>
       </div>

       <div class="row">
           <div class="col span_1_of_4 box">
                <img src="img/flag.png" alt="flag" class="service-icon">
                <h3>BRANDING</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut cum vero veniam</p>
           </div>
            <div class="col span_1_of_4 box">
                <img src="img/crayon.png" alt="pencil" class="service-icon">
                <h3>DESIGN</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut cum vero veniam</p>
            </div>
            <div class="col span_1_of_4 box">
                <img src="img/gears.png" alt="setting" class="service-icon">
                <h3>DEVELOPMENT</h3>
                <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Aut cum vero veniam</p>
            </div>
            <div class="col span_1_of_4 box">
                <img src="img/rocket.png" alt="rocket" class="service-icon">
...
<section class="team-section" id="team">
    ...
    <div class="row">
        <div class="col span_1_of_4 box">
            <img src="img/1.jpg" alt="ANNE HATHAWAY" class="team-member">
            <h3>ANNE HATHAWAY</h3>
        ...
        <div class="col span_1_of_4 box">
            <img src="img/2.jpg" alt="ANNE HATHAWAY" class="team-member">
            <h3>ANNE HATHAWAY</h3>
            <span class="role">CEO / Marketing Guru</span>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna.</p>
            <div class="social-link">
        ...
        <div class="col span_1_of_4 box">
            <img src="img/3.jpg" alt="ANNE HATHAWAY" class="team-member">
            <h3>ANNE HATHAWAY</h3>
            <span class="role">CEO / Marketing Guru</span>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna.</p>
            <div class="social-link">
        ...
        <div class="col span_1_of_4 box">
            <img src="img/4.jpg" alt="ANNE HATHAWAY" class="team-member">
            <h3>ANNE HATHAWAY</h3>
            <span class="role">CEO / Marketing Guru</span>
            <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam nonummy nibh euismod tincidunt ut laoreet dolore magna.</p>
            <div class="social-link">
...
<section class="skill-section" id="skill">
    ...
    <div class="row">
        <div class="col span_1_of_4 box">
            <svg class="radial-progress web" data-percentage="95" viewBox="0 0 80 80">
        ...
        <div class="col span_1_of_4 box">
            <svg class="radial-progress html" data-percentage="75" viewBox="0 0 80 80">
                <circle class="incomplete" cx="40" cy="40" r="35"></circle>
                <circle class="complete" cx="40" cy="40" r="35" style="stroke-dashoffset: 39.58406743523136;"></circle>
        ...
        <div class="col span_1_of_4 box">
            <svg class="radial-progress graphics" data-percentage="70" viewBox="0 0 80 80">
                <circle class="incomplete" cx="40" cy="40" r="35"></circle>
                <circle class="complete" cx="40" cy="40" r="35" style="stroke-dashoffset: 39.58406743523136;"></circle>
...
<section class="portfolio-section" id="portfolio">
    ...
    <div class="row container">
        <div class="col span_1_of_2 mix web apps box">
            <img src="img/portfolio1.png" alt="Isometric Perspective Mock-Up" class="portfolio-image">
            <h4>Isometric Perspective Mock-Up</h4>
        </div>
        <div class="col span_1_of_2 mix web icons box">
            <img src="img/portfolio2.png" alt="Isometric Perspective Mock-Up" class="portfolio-image">
            <h4>Isometric Perspective Mock-Up</h4>
        </div>
        <div class="col span_1_of_2 mix apps box">
            <img src="img/portfolio3.png" alt="Isometric Perspective Mock-Up" class="portfolio-image">
            <h4>Isometric Perspective Mock-Up</h4>
        </div>
        <div class="col span_1_of_2 mix icons box">
            <img src="img/portfolio4.png" alt="Isometric Perspective Mock-Up" class="portfolio-image">
            <h4>Isometric Perspective Mock-Up</h4>
        </div>
    </div>
    <div class="row">
        <button type="button" class="btn btn-load-more">Load More Projects</button>
    </div>
...
<section class="testimonial-section" id="testimonial">
    <div class="row">
        ...
        <p class="little-description">Our client love us!</p>
    </div>
    <div class="row">
...
<section class="contact-section" id="contact">
    ...
    <div class="row">
        <form action="https://formspree.io/abirdas422@gmail.com" method="POST">
            <div class="row">
                <div class="col span_1_of_2">
                    <input type="text" id="Nmae" placeholder="Your Names*" required>
                </div>
                <div class="col span_1_of_2">
    ...
    <script async src="https://www.googletagmanager.com/gtag/js?id=UA-174272038-1"></script>
    <script>
        window.dataLayer = window.dataLayer || [];
        function gtag() { dataLayer.push(arguments); }
        gtag('js', new Date());

        gtag('config', 'UA-174272038-1');
    </script>
